...
COMMON_PATH := device/xiaomi/odin
...
TARGET_PREBUILT_KERNEL := $(DEVECE_PATH)/prebuilt/Image.gz.img
TARGET_PREBUILT_DTB := $(DEVECE_PATH)/prebuilt/dtb.img
TARGET_PREBUILT_DTBOIMAGE := $(DEVECE_PATH)/prebuilt/dtbo.img
BOARD_INCLUDE_RECOVERY_DTBO := ture
...
TARFET_KERNEL_SOURCE := kernel/xiaomi/odin
